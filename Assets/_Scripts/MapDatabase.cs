...
public class MapDatabase : MonoBehaviour {
	...
	public void fillEmptyMapDBInfo()
	{
		for(int i=0; i<mapData.GetLength(0); i++)
		{
			for(int j=0; j<mapData.GetLength(1); j++)
			{
				...
				mapData[i,j].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D;
	...
	public void initializeMapDBInfo()
	{
		...
		mapData[0,2].locationSprite = Resources.Load("Assets/Map/start_room2") as Texture2D; //Sprite name
		...
		mapData[1,2].locationSprite = Resources.Load("Assets/Map/start_room2") as Texture2D;
		...
		mapData[1,3].locationSprite = Resources.Load("Assets/Map/start_room2") as Texture2D; 
		...
		mapData[2,2].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[3,2].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[4,2].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[3,1].locationSprite = Resources.Load("Assets/Map/ruin_room2") as Texture2D; 
		...
		mapData[5,0].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[8,0].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[5,1].locationSprite = Resources.Load("Assets/Map/ruin_room2") as Texture2D; 
		...
		mapData[6,1].locationSprite = Resources.Load("Assets/Map/ruin_room2") as Texture2D; 
		...
		mapData[7,1].locationSprite = Resources.Load("Assets/Map/ruin_room2") as Texture2D; 
		...
		mapData[5,2].locationSprite = Resources.Load("Assets/Map/ruin_room2") as Texture2D; 
		...
		mapData[6,2].locationSprite = Resources.Load("Assets/Map/ruin_room2") as Texture2D; 
		...
		mapData[7,2].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[5,3].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[8,3].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[5,4].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[6,4].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[7,4].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[8,4].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[9,4].locationSprite = Resources.Load("Assets/Map/ruin_room2") as Texture2D; 
		...
		mapData[5,5].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[6,5].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[8,5].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[9,5].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
		...
		mapData[10,5].locationSprite = Resources.Load("Assets/Map/reg_room2") as Texture2D; 
